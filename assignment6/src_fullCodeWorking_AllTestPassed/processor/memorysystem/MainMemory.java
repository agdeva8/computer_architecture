...
//		System.out.println("in MM");
		...
		if(e.getEventType() == EventType.MemoryRead)
		{
			...
			// sending to cache
//			System.out.println("MM: memoryread response to cache");
			...
			// sending to pipeline
//			System.out.println("MM: memoryread response to pipeline");
			Simulator.getEventQueue().addEvent(
					new MemoryResponseEvent(
							Clock.getCurrentTime(),
							this,
		...
		if(e.getEventType() == EventType.MemoryWrite)
		{
			...
			// sending to cache;
//			System.out.println("MM: memory write response to cache");
			Simulator.getEventQueue().addEvent(
					new MemoryResponseEvent(
							Clock.getCurrentTime(),
							this,
...
//			System.out.println("MM: memorywrite response to cache");
		...
		{
//			System.out.println("MM: memorywrite through response nowhere");
