...
public class OperandFetch {
	...
	{
//		System.out.println("pending task is " + IF_OF_Latch.isPendingTask());
		// reseting the fetch becuase branch is taken;
		if(isBranchTaken)
		{
//			System.out.println("OF: branch taken");
			instruction = 0;
			currentPC = 0;
			isBranchTaken = false;
...
//		System.out.println("pending task is "+IF_OF_Latch.isPendingTask());
//		System.out.println("OF: conflict "+IF_OF_Latch.isOFConflict());
//		System.out.println("OF: busy " + IF_OF_Latch.isOFBusy());
		//if(IF_OF_Latch.isOF_enable() || IF_OF_Latch.isPendingTask())
		if(IF_OF_Latch.isPendingTask())
		{
//			if(IF_OF_Latch.isOF_enable())
//				System.out.println("OF: enabled");
//			
//			if(IF_OF_Latch.isPendingTask())
//				System.out.println("OF: pending");
			...
			if (!isConfict()) {
//				System.out.println("OF: not in conflict");
				performNoConflict();
			}
			else {
//				System.out.println("OF: in conflict");
				IF_OF_Latch.setOFConflict(true);
				OF_EX_Latch.setEX_enable(false);
			}
		}
		else {
//			System.out.println("OF: not enabled");
			OF_EX_Latch.setEX_enable(false);
		}
			if(OF_EX_Latch.getIsBranchTaken())
				isBranchTaken = true;
