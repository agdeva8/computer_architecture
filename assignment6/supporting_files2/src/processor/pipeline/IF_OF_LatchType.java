...
public class IF_OF_LatchType {
	...
	{
		this.pendingTask += 1;
//		System.out.println("IF OF Latch: updatePending "+pendingTask);
	}
	
	public void donePendingTask()
	{
		this.pendingTask -= 1;
//		System.out.println("IF OF Latch: donePending "+pendingTask);
	}
	
	public void nullPendingTask()
	{
		this.pendingTask = 0;
//		System.out.println("IF OF Latch: nullPending "+pendingTask);
	}
}
