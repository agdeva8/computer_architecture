...
public class Event {
	...
	public enum EventType {CacheRead,CacheWrite,CacheResponse,MemoryWriteThrough,ExecutionComplete,CPUMul,CPUDiv,CPUAlu, MemoryRead, MemoryResponse, MemoryWrite};
